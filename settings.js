...
SESSION_ID: process.env.SESSION_ID === undefined ? 'QSM~RudGDArY#fuulVOgCtKsQeK3eshO9Nw11In9vF0Je47y374C8Bxs' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
JID: process.env.JID || "120363319582281705@newsletter",
FOOTER: '',
